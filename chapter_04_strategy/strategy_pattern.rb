# With this pattern we are prefering Delegation over Inheritance
# With this pattern is simpler to change at runtime the Formatter and to create a new
# it just has to respond_to `output_report`
class Formatter
...
# In that case the variable flow will be less, the Report class And the formatter will be more
# couple
...
# that way we could create Reports out of thin air. This way we could create
# an interface than accepts a block
